...
import { StyleSheet, Dimensions, View, Text, Image, TouchableOpacity, ScrollView, Animated, Pressable } from 'react-native';
...
export default function EventDetailsScreen(props: EventCard) {
      ...
      >
        <Animated.View style={[
              ...
              <View style={styles.eventDetails}>
                <View style={styles.eventInfo}>
                  ...
                  <View style={styles.eventInfoText}>
                    ...
                    <Text style={styles.eventInfoSubtitle}>{props.date}</Text>
                  </View>
                </View>
                <View style={styles.eventInfo}>
                  ...
                  <View style={styles.eventInfoText}>
                    ...
                    <Text style={styles.eventInfoSubtitle}>{props.time}</Text>
                  </View>
                </View>
                <View style={styles.eventInfo}>
          ...
          <View style={styles.footer}>
            ...
            <TouchableOpacity style={[styles.buyButton, {backgroundColor: colors.accent}]} onPress={()=>console.log("buy")}>
